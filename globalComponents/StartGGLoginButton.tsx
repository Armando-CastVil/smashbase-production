...
export const StartGGLoginButton = () => {
    const handleLoginClick = () => {
      ...
      window.location.href = `https://start.gg/oauth/authorize?response_type=code&client_id=${CLIENT_ID}&scope=user.identity%20user.email%20tournament.manager%20tournament.reporter&redirect_uri=${REDIRECT_URI}`;
    };
